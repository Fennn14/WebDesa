...
<head>
  ...
  <title>Enkripsi - Implementasi Keamanan Sistem Informasi Desa Namo Buaya Menggunakan Metode 
  AES128-bit </title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          <h1 class="h4 mb-0 ml-2 text-gray-800">Enkripsi - Implementasi Keamanan Sistem Informasi Desa Namo Buaya Menggunakan Metode 
          AES128-bit</h1>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="card-body">
                    ...
                    <p>2. Kunci Enkripsi berjumlah maksimal 16 digit.</p>
                    <p>3. Masukkan keterangan/deskripsi file dengan jelas.</p>
