        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h1 class="h4 mb-0 ml-2 text-gray-800">Tentang Aplikasi - Implementasi Keamanan Sistem Informasi Desa Namo Buaya Menggunakan Metode 
                    AES128-bit</h1>
                ...
                <div class="container-fluid">
                    <div class="alert alert-success" role="alert">
                        ...
                        Implementasi Keamanan Sistem Informasi Desa Namo Buaya Menggunakan Metode 
  AES128-bit - Tentang Aplikasi
                    </div>
                    <div class="col-md-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <h5>Implementasi Keamanan Sistem Informasi Desa Namo Buaya Menggunakan Metode 
                                AES128-bit</h5>
                                <h6>( Studi Kasus: Desa Namo Buaya )</h6>
                                <br>
                                <p>Implementasi Metode Enkripsi AES 128 Bit pada File pada Desa Namo Buaya, bertujuan
                                    untuk meminimalisir penyalahgunaan data rahasia kependudukan oleh pihak yang tidak bertanggungjawab. Metode Enkripsi
                                    AES 128 Bit digunakan untuk mengubah file kependudukan menjadi file ciphertext atau file yang sulit untuk dimengerti makna dan isinya.
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Implementasi Keamanan Sistem Informasi Desa Namo Buaya Menggunakan Metode 
                        AES128-bit 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
